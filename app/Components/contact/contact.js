...
export default function Contact() {
  const ref=useRef()
  return (
    <div className="Aboutpage  flex  justify-center w-full items-end pb-[50px]">
      <div className="w-[calc(100%-80px)] max-w-[1500px] grid grid-cols-2 home-flex">
        <div className="min-w-[100px] hidecont">
          <p className="text-6xl font-medium max-w-[1000px] mt-[100px] mb-[50px] text-revel-first">Build with us</p>
      ...
      <form className=" backdrop-blur-lg flex flex-col p-7 w-3/4 rounded-2xl border-2 border-black makecontfll">
