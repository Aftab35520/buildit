    ...
    <div className="bg-white text-black ">
      <div className="w-full h-dvh relative overflow-hidden mb-20 ">
        ...
        <div className=" absolute top-[40%] left-0 w-full h-dvh p-6 ">
          ...
          <p className="text-6xl text-white font-medium max-w-[1000px] mt-4 text-revel-first-white text-center bigtext" >Transforming Vision <br/>Empowering Dreams</p>
      ...
      <div className="flex justify-center bg-[#1E1B1B] text-white mt-60">
        <div className="w-[calc(100%-80px)] max-w-[1500px] ">
          <p className="text-[50px] font-medium max-w-[1000px] mt-[150px] leading-[55px] mb-[50px] text-revel-white bigtext">Embracing Wholeness for<br/> Effective Solutions Together</p>
