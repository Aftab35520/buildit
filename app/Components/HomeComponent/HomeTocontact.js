  ...
  return (
    <div className="w-full  bg-[#1E1B1B] flex justify-center  ">
        <div className="w-[calc(100%-80px)] max-w-[1500px] pt-32">
            <p className="text-white text-6xl font-medium max-w-[1000px] text-revel-white bigtext ">Like Our Style? Let's Make an <span className=" text-revel-red ">IMPACT</span> ToGether</p>
