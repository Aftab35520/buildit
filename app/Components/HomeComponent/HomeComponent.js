    ...
    <div>
      ...
      <div className="w-full flex flex-col items-center  justify-center bg-white text-black">
        <div className="w-[calc(100%-80px)] max-w-[1500px]">
            <p className=" text-6xl font-medium max-w-[1000px] mt-4 bigtext  reveal-text-start ">Empower Your Brand Design <br/> Websites That Captivate</p>
       ...
       <Homeanim/>
        ...
        <div className="w-[calc(100%-80px)] max-w-[1500px] mt-24 grid grid-cols-2 home-flex ">
              <div>
                ...
                <p className=" text-6xl font-medium max-w-[1000px] mt-4  reveal-text  bigtext">Crafting Success<br/> from Creative<br/> Concepts</p>
