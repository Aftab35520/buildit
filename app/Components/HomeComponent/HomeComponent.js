...
export default function HomeComponent() {
  return (
    <div className="w-full flex flex-col items-center mt-[150px] justify-center ">
       ...
       <Homeanim/>
        ...
        <div className="w-[calc(100%-80px)] max-w-[1500px] mt-24 grid grid-cols-2 home-flex ">
              <div>
                ...
                <p className=" text-6xl font-medium max-w-[1000px] mt-4 text-revel  bigtext">Crafting Success<br/> from Creative<br/> Concepts</p>
